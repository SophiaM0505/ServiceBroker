  ...
  //reduce balance with actually consumed cost or cpu time after job completion
    public static void mPolicyShareCompleteReduce(long cont_id, String end_time) throws OWLOntologyCreationException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException, OWLOntologyStorageException, InterruptedException{
		...
		if(measurement.equalsIgnoreCase("second")){
			...
			System.out.println("=======timer complete duration: " + duration);
			...
			if (pri == 1){
				...
				//if over privilege, to update manager's balance in MappingPolicy
		    ...
		    System.out.println("+++++++++ policy ontology's user maxCost: " + user_maxCost);
    ...
    public static void mPolicyShareCompleteReduce(long cont_id, long duration) throws InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException, OWLOntologyCreationException, InterruptedException, OWLOntologyStorageException{
    	//double balance;
    	double cpu_balance;
...
//public final static void main(String[] args) throws OWLOntologyCreationException, OWLOntologyStorageException{
   ...
   /* public static void main(String[] args) throws OWLOntologyCreationException, InstantiationException, IllegalAccessException, ClassNotFoundException, SQLException, OWLOntologyStorageException{
 	   //double cost = 5.5;
 	   mPolicyShareCloudPartReduce();
 	   System.out.println("done.");
    }*/
